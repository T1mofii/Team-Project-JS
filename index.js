import{i as c,a as b,S as T}from"./assets/vendor-C-jDU7ko.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function i(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();function w(e){e&&c.show({title:"❌",message:`Sorry, there are no ${e}.`,color:"red",position:"topRight",messageColor:"white",titleColor:"white",timeout:5e3})}function $(e){e.message&&c.show({title:"Error",color:"red",position:"topRight",messageColor:"white",titleColor:"white",message:e.message,timeout:5e3})}b.defaults.baseURL="https://sound-wave.b.goit.study/api/";let L;async function M(e,t={}){try{return(await b.get(e,{params:t})).data}catch(n){return $(n),null}}async function I(e){L=`artists/${e}`;const t=await M(L);return t||w("artist")}async function q(e=10,t=1){const n=await M("feedbacks",{limit:e,page:t});if(!n)return[];const i=n.data;return i&&Array.isArray(i)&&i.length>0?i:w("feedbacks")}function P(e){const t=Math.round(e),n=5;let i="";for(let s=1;s<=n;s++)i+=s<=t?"★":"☆";return`<div class="stars">${i}</div>`}function D(e){const t=document.querySelector(".swiper-wrapper");if(!t)return;const n=e.map(({rating:i,descr:s,name:r})=>`
      ...
      </div>`).join("");t.innerHTML=n}function O(){const e=new T(".swiper",{direction:"horizontal",loop:!1,slidesPerView:1,spaceBetween:20,pagination:{el:".swiper-pagination",clickable:!0,type:"custom",renderCustom:function(n,i,s){const r=n.slides.length;let o=2;return n.realIndex===0?o=1:n.realIndex===r-1&&(o=3),[1,2,3].map(p=>`<span class="swiper-pagination-bullet${p===o?" swiper-pagination-bullet-active":""}" data-index="${p}"></span>`).join("")}},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"}}),t=document.querySelector(".swiper-pagination");t&&t.addEventListener("click",function(n){if(!n.target.classList.contains("swiper-pagination-bullet"))return;const i=Number(n.target.dataset.index),s=e.slides.length;let r=0;i===1?r=0:i===3?r=s-1:r=Math.floor((s-1)/2),e.slideTo(r)})}async function j(){try{const e=await q(10,1);D(e),e.length<=1?document.querySelector(".swiper-pagination").style.display="none":document.querySelector(".swiper-pagination").style.display="flex",O()}catch(e){console.error("Ошибка при загрузке фидбеков:",e)}}j();const l=document.querySelector("[data-feedback-modal]"),N=document.querySelector("[data-feedback-modal-open]"),z=document.querySelector("[data-feedback-modal-close]");N.addEventListener("click",()=>{l.classList.remove("is-hidden")});z.addEventListener("click",()=>{l.classList.add("is-hidden")});l.addEventListener("click",e=>{e.target===l&&l.classList.add("is-hidden")});document.addEventListener("keydown",e=>{e.key==="Escape"&&!l.classList.contains("is-hidden")&&l.classList.add("is-hidden")});const f=document.getElementById("artist-modal-backdrop");document.getElementById("artist-modal");const F=document.getElementById("artist-close-btn"),k=document.getElementById("artist-loader"),g=document.getElementById("artist-content");let d=null,u=null;async function Y(e){if(!e)return console.error("Artist ID is missing!");if(f.classList.contains("hidden")){f.classList.remove("hidden"),k.classList.remove("hidden"),g.classList.add("hidden"),document.body.style.overflow="hidden";try{const t=await I(e);if(!t){w("artist"),v();return}const n=t.tracksList||[],i={};n.forEach(r=>{const o=r.strAlbum||"Unknown Album";i[o]||(i[o]=[]),i[o].push(r)});const s=Object.entries(i).map(([r,o])=>({strAlbum:r,tracks:o}));R(t,s)}catch(t){console.error(t),g.innerHTML="<p>Error loading artist.</p>",$(t)}finally{k.classList.add("hidden"),g.classList.remove("hidden")}H()}}function v(){f.classList.add("hidden"),document.body.style.overflow="",W()}function H(){d||(d=e=>{e.key==="Escape"&&v()},document.addEventListener("keydown",d)),u||(u=e=>{e.target===f&&v()},f.addEventListener("click",u))}function W(){d&&(document.removeEventListener("keydown",d),d=null),u&&(f.removeEventListener("click",u),u=null)}function R(e,t){const n=e.intFormedYear?e.intDiedYear&&e.intDiedYear!=="null"?`${e.intFormedYear} - ${e.intDiedYear}`:`${e.intFormedYear} - present`:"information missing";g.innerHTML=`

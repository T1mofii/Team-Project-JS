import{i as l,a as v}from"./assets/vendor-mzhaXv-m.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();function L(e){l.show({title:"❌",message:`Sorry, there are no ${e}.`,color:"red",position:"topRight",messageColor:"white",titleColor:"white",timeout:5e3})}function w(e){e.message&&l.show({title:"Error",color:"red",position:"topRight",messageColor:"white",titleColor:"white",message:e.message,timeout:5e3})}v.defaults.baseURL="https://sound-wave.b.goit.study/api/";async function B(e,t={}){try{return(await v.get(e,{params:t})).data}catch(n){return w(n),null}}async function S(e){if(!e)return null;const t=await B(`artists/${e}`);return t||(L("artist"),null)}const m=document.getElementById("artist-modal-backdrop");document.getElementById("artist-modal");const I=document.getElementById("artist-close-btn"),b=document.getElementById("artist-loader"),f=document.getElementById("artist-content");let c=null,d=null;async function T(e){if(!e)return console.error("Artist ID is missing!");if(m.classList.contains("hidden")){m.classList.remove("hidden"),b.classList.remove("hidden"),f.classList.add("hidden"),document.body.style.overflow="hidden";try{const t=await S(e);if(!t){L("artist"),g();return}const n=t.tracksList||[],o={};n.forEach(s=>{const i=s.strAlbum||"Unknown Album";o[i]||(o[i]=[]),o[i].push(s)});const r=Object.entries(o).map(([s,i])=>({strAlbum:s,tracks:i}));O(t,r)}catch(t){console.error(t),f.innerHTML="<p>Error loading artist.</p>",w(t)}finally{b.classList.add("hidden"),f.classList.remove("hidden")}P()}}function g(){m.classList.add("hidden"),document.body.style.overflow="",x()}function P(){c||(c=e=>{e.key==="Escape"&&g()},document.addEventListener("keydown",c)),d||(d=e=>{e.target===m&&g()},m.addEventListener("click",d))}function x(){c&&(document.removeEventListener("keydown",c),c=null),d&&(m.removeEventListener("click",d),d=null)}function O(e,t){const n=e.intFormedYear?e.intDiedYear&&e.intDiedYear!=="null"?`${e.intFormedYear} - ${e.intDiedYear}`:`${e.intFormedYear} - present`:"information missing";f.innerHTML=`
...
`;function o(r){if(!r)return"-";const s=Math.floor(r/1e3),i=Math.floor(s/60),y=s%60;return`${i}:${y.toString().padStart(2,"0")}`}I.addEventListener("click",g)}const a={cardItem:document.querySelector(".js-artist-card"),loader:document.querySelector(".js-artist-loader"),btnLoadMore:document.querySelector(".js-artist-loadmore-btn")};async function M(e){return(await v.get("https://sound-wave.b.goit.study/api/artists",{params:{page:e,limit:8}})).data}function q(e,t){return e?e.length>t?e.slice(0,t)+"...":e:""}function $(e){return e.map(n=>{const o=n.genres?n.genres.map(i=>`<li class="item-info-genre">${i}</li>`).join(""):"";let r;window.innerWidth<320||window.innerWidth<768?r=64:window.innerWidth<1440?r=160:r=139;const s=q(n.strBiographyEN,r);return`<li class="artist-card-item">

import{i as c,a as v}from"./assets/vendor-CBES6XuS.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const s of t)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function n(t){const s={};return t.integrity&&(s.integrity=t.integrity),t.referrerPolicy&&(s.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?s.credentials="include":t.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(t){if(t.ep)return;t.ep=!0;const s=n(t);fetch(t.href,s)}})();function w(e){c.show({title:"❌",message:`Sorry, there are no ${e}.`,color:"red",position:"topRight",messageColor:"white",titleColor:"white",timeout:5e3})}function M(e){e.message&&c.show({title:"Error",color:"red",position:"topRight",messageColor:"white",titleColor:"white",message:e.message,timeout:5e3})}v.defaults.baseURL="https://sound-wave.b.goit.study/api/";let b;async function S(e){try{b=`artists/${e}`;const n=(await v.get(b,{})).data;return n||w("artist")}catch(r){M(r)}}const m=document.getElementById("artist-modal-backdrop");document.getElementById("artist-modal");const T=document.getElementById("artist-close-btn"),L=document.getElementById("artist-loader"),f=document.getElementById("artist-content");let l=null,d=null;async function I(e){if(!e)return console.error("Artist ID is missing!");if(m.classList.contains("hidden")){m.classList.remove("hidden"),L.classList.remove("hidden"),f.classList.add("hidden"),document.body.style.overflow="hidden";try{const r=await S(e);if(!r){w("artist"),p();return}const n=r.tracksList||[],o={};n.forEach(s=>{const i=s.strAlbum||"Unknown Album";o[i]||(o[i]=[]),o[i].push(s)});const t=Object.entries(o).map(([s,i])=>({strAlbum:s,tracks:i}));q(r,t)}catch(r){console.error(r),f.innerHTML="<p>Error loading artist.</p>",M(r)}finally{L.classList.add("hidden"),f.classList.remove("hidden")}O()}}function p(){m.classList.add("hidden"),document.body.style.overflow="",P()}function O(){l||(l=e=>{e.key==="Escape"&&p()},document.addEventListener("keydown",l)),d||(d=e=>{e.target===m&&p()},m.addEventListener("click",d))}function P(){l&&(document.removeEventListener("keydown",l),l=null),d&&(m.removeEventListener("click",d),d=null)}function q(e,r){const n=e.intFormedYear?e.intDiedYear&&e.intDiedYear!=="null"?`${e.intFormedYear} - ${e.intDiedYear}`:`${e.intFormedYear} - present`:"information missing";f.innerHTML=`
...
`;function o(t){if(!t)return"-";const s=Math.floor(t/1e3),i=Math.floor(s/60),y=s%60;return`${i}:${y.toString().padStart(2,"0")}`}T.addEventListener("click",p)}const a={cardItem:document.querySelector(".js-artist-card"),loader:document.querySelector(".js-artist-loader"),btnLoadMore:document.querySelector(".js-artist-loadmore-btn")};async function $(e){return(await v.get("https://sound-wave.b.goit.study/api/artists",{params:{page:e,limit:8}})).data}function x(e,r){return e?e.length>r?e.slice(0,r)+"...":e:""}function C(e){return e.map(n=>{const o=n.genres?n.genres.map(i=>`<li class="item-info-genre">${i}</li>`).join(""):"";let t;window.innerWidth<320||window.innerWidth<768?t=64:window.innerWidth<1440?t=160:t=139;const s=x(n.strBiographyEN,t);return`<li class="artist-card-item">
            ...
            </li>`}).join("")}function D(e){if(!a.cardItem){console.error("Container .js-artist-card not found");return}a.cardItem.innerHTML=e}function A(){a.loader&&a.loader.classList.add("is-active-loader")}function k(){a.loader&&a.loader.classList.remove("is-active-loader")}function E(){a.btnLoadMore.disabled=!1,a.btnLoadMore.classList.add("artist-load-more-btn-is-active")}function h(){a.btnLoadMore.disabled=!0,a.btnLoadMore.classList.remove("artist-load-more-btn-is-active")}async function j(e){const r=e.target.closest(".artist-learn-btn");if(!r)return;const n=r.dataset.artistId,o=r.closest(".artist-card-item").querySelector(".card-item-title").textContent;if(!n){c.error({message:"Artist ID not found"});return}console.log("Opening modal for artist:",o,"ID:",n);try{const t=r.textContent;r.disabled=!0,r.textContent="Loading...",await I(n)}catch(t){console.error("Error opening modal:",t),c.error({message:"Failed to open artist details. Please try again."})}finally{r.disabled=!1,r.textContent="Learn More"}}let u,g=0;const N=8;document.addEventListener("DOMContentLoaded",async()=>{u=1,A();try{const e=await $(u),r=e.artists,n=C(r);D(n),a.cardItem.addEventListener("click",j),g=Math.ceil(e.totalArtists/N),u<g?E():(h(),c.error({message:"We're sorry, but you've reached the end of search results."}))}catch(e){console.error("Error loading artists:",e),g=0,c.error({message:"Sorry. Please try again!"})}finally{k()}});a.btnLoadMore.addEventListener("click",async()=>{u+=1,h(),A();try{const e=await $(u);if(!e.artists.length){c.info({message:"Sorry. Please try again!"});return}const r=e.artists,n=C(r);a.cardItem.insertAdjacentHTML("beforeend",n);const o=document.querySelector(".artist-card-item");if(!o)return;const t=o.getBoundingClientRect().height;window.scrollBy({top:t*2,behavior:"smooth"})}catch(e){console.error("Error loading more artists:",e),c.error({message:"Sorry, there are no information. Please try again!"})}finally{k(),u<g?E():(h(),c.error({message:"We're sorry, but you've reached the end of search results."}))}});(()=>{const e={openModalBtn:document.querySelector("[data-menu-open]"),closeModalBtn:document.querySelector("[data-menu-close]"),modal:document.querySelector("[data-menu]"),header:document.querySelector(".header")},r=document.querySelectorAll(".mob-menu-link, .nav-link");function n(){e.modal.classList.toggle("mob-is-open")}e.openModalBtn&&e.openModalBtn.addEventListener("click",n),e.closeModalBtn&&e.closeModalBtn.addEventListener("click",n),r.forEach(o=>{o.addEventListener("click",t=>{t.preventDefault();const s=document.querySelector(o.getAttribute("href"));if(!s)return;const i=e.header.offsetHeight,B=s.getBoundingClientRect().top+window.pageYOffset-i;window.scrollTo({top:B,behavior:"smooth"}),o.classList.contains("mob-menu-link")&&e.modal.classList.remove("mob-is-open")})})})();
